    ...
    <section className="relative flex min-h-[85vh] items-center overflow-hidden">
      ...
      <div className="container relative z-10 py-20">
        ...
        >
          ...
          <p className="mt-6 text-base leading-relaxed text-primary-foreground/85 sm:text-lg lg:text-xl">
            {t("hero.subtitle")}
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-4">
            ...
            <Button asChild variant="outline" size="lg" className="w-full border-white/70 bg-transparent text-white hover:bg-white/10 hover:text-white sm:w-auto font-semibold">
