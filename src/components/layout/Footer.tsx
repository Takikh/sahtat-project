...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-primary text-primary-foreground dark:bg-slate-950 dark:text-slate-100">
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <img src="/logo.svg" alt="Sahtat Promotion" className="h-20 w-auto" />
            <p className="mt-3 text-sm text-primary-foreground/90 dark:text-slate-300">{t("footer.description")}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/90 dark:text-slate-300">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/90 dark:text-slate-300">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-primary-foreground/20 pt-8 text-xs text-primary-foreground/75 dark:border-slate-700 dark:text-slate-400 sm:flex-row">
